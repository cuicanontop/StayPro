package dev.cuican.staypro.gui.ViaForge;

import com.google.common.util.concurrent.ThreadFactoryBuilder;
import com.viaversion.viaversion.ViaManagerImpl;
import com.viaversion.viaversion.api.Via;
import com.viaversion.viaversion.api.data.MappingDataLoader;
import dev.cuican.staypro.gui.ViaForge.loader.BackwardsLoader;
import dev.cuican.staypro.gui.ViaForge.platform.Injectors;
import dev.cuican.staypro.gui.ViaForge.platform.Platform;
import dev.cuican.staypro.gui.ViaForge.platform.ProviderLoader;
import dev.cuican.staypro.gui.ViaForge.util.JLoggerToLog4j;
...
public class ViaForge {
    ...
    private final Logger jLogger = new JLoggerToLog4j(LogManager.getLogger("ViaForge-Stay"));
