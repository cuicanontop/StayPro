package dev.cuican.staypro.gui.alt;

import com.mojang.realmsclient.gui.ChatFormatting;
import dev.cuican.staypro.gui.alt.utils.*;
import dev.cuican.staypro.gui.window.EmptyWindowNoDrag;
import dev.cuican.staypro.gui.window.components.ButtonAlt;
import dev.cuican.staypro.utils.FontUtils;
...
public final class GuiAlt extends GuiScreen {
    ...
    public void drawScreen(int x2, int y2, float z2) {
        ...
        FontUtils.drawStringWithShadow("Alt Login", (int) (width / 2F), 20, -1);
        FontUtils.drawStringWithShadow(this.thread == null ? ChatFormatting.GRAY + "Idle..." : this.thread.getStatus(), (int) (width / 2F), 29, -1);
