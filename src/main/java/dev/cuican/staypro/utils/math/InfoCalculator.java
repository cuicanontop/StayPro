package dev.cuican.staypro.utils.math;
...
public class InfoCalculator {
    ...
    public static void setTimer(Float I){
        ((AccessorTimer)((AccessorMinecraft)Minecraft.getMinecraft()).aqGetTimer()).aqSetTickLength(I);
    }

    public static String speed(boolean useUnitKmH, Minecraft mc) {

        float currentTps =((AccessorTimer)((AccessorMinecraft)mc).aqGetTimer()).aqGetTickLength()/ 1000.0f;
        double multiply = 1.0;
    ...
    public static double getSpeedKpH(Minecraft mc) {
