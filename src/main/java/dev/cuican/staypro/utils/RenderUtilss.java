...
public class RenderUtilss extends Module
{
    ...
    public static void updateModelViewProjectionMatrix() {
        GL11.glGetFloat(2982, RenderUtilss.modelView);
        GL11.glGetFloat(2983, RenderUtilss.projection);
        GL11.glGetInteger(2978, RenderUtilss.viewport);
    ...
    public static AxisAlignedBB interpolateAxis(final AxisAlignedBB bb) {
        return new AxisAlignedBB(bb.minX - RenderUtilss.mc.getRenderManager().viewerPosX, bb.minY - RenderUtilss.mc.getRenderManager().viewerPosY, bb.minZ - RenderUtilss.mc.getRenderManager().viewerPosZ, bb.maxX - RenderUtilss.mc.getRenderManager().viewerPosX, bb.maxY - RenderUtilss.mc.getRenderManager().viewerPosY, bb.maxZ - RenderUtilss.mc.getRenderManager().viewerPosZ);
    }
    ...
    public static void drawGradientPlane(final BlockPos pos, final EnumFacing face, final Color startColor, final Color endColor, final boolean half, final boolean top) {
        ...
        final IBlockState iblockstate = RenderUtilss.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtilss.mc.player, RenderUtilss.mc.getRenderPartialTicks());
        final AxisAlignedBB bb = iblockstate.getSelectedBoundingBox((World)RenderUtilss.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z);
    ...
    public static void drawGradientPlane(final BlockPos pos, final EnumFacing face, final Color startColor, final Color endColor, final double height) {
        ...
        final IBlockState iblockstate = RenderUtilss.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtilss.mc.player, RenderUtilss.mc.getRenderPartialTicks());
        final AxisAlignedBB bb = iblockstate.getSelectedBoundingBox((World)RenderUtilss.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z).expand(0.0, height, 0.0);
        final float red = startColor.getRed() / 255.0f;
        final float green = startColor.getGreen() / 255.0f;
        final float blue = startColor.getBlue() / 255.0f;
        final float alpha = startColor.getAlpha() / 255.0f;
    ...
    public static void drawGradientBlockOutline(final BlockPos pos, final Color startColor, final Color endColor, final float linewidth, final double height) {
        final IBlockState iblockstate = RenderUtilss.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtilss.mc.player, RenderUtilss.mc.getRenderPartialTicks());
        drawGradientBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtilss.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z).expand(0.0, height, 0.0), startColor, endColor, linewidth);
    }
    ...
    public static void drawProperGradientBlockOutline(final BlockPos pos, final Color startColor, final Color midColor, final Color endColor, final float linewidth) {
        final IBlockState iblockstate = RenderUtilss.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtilss.mc.player, RenderUtilss.mc.getRenderPartialTicks());
        drawProperGradientBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtilss.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), startColor, midColor, endColor, linewidth);
    }
    ...
    public static void drawGradientFilledBox(final BlockPos pos, final Color startColor, final Color endColor) {
        final IBlockState iblockstate = RenderUtilss.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtilss.mc.player, RenderUtilss.mc.getRenderPartialTicks());
        drawGradientFilledBox(iblockstate.getSelectedBoundingBox((World)RenderUtilss.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), startColor, endColor);
    }
    ...
    public static void glScissor(final float x, final float y, final float x1, final float y1, final ScaledResolution sr) {
        GL11.glScissor((int)(x * sr.getScaleFactor()), (int)(RenderUtilss.mc.displayHeight - y1 * sr.getScaleFactor()), (int)((x1 - x) * sr.getScaleFactor()), (int)((y1 - y) * sr.getScaleFactor()));
    }
    ...
    public static void drawBox(final BlockPos pos, final Color color) {
        final AxisAlignedBB bb = new AxisAlignedBB(pos.getX() - RenderUtilss.mc.getRenderManager().viewerPosX, pos.getY() - RenderUtilss.mc.getRenderManager().viewerPosY, pos.getZ() - RenderUtilss.mc.getRenderManager().viewerPosZ, pos.getX() + 1 - RenderUtilss.mc.getRenderManager().viewerPosX, pos.getY() + 1 - RenderUtilss.mc.getRenderManager().viewerPosY, pos.getZ() + 1 - RenderUtilss.mc.getRenderManager().viewerPosZ);
        RenderUtilss.camera.setPosition(Objects.requireNonNull(RenderUtilss.mc.getRenderViewEntity()).posX, RenderUtilss.mc.getRenderViewEntity().posY, RenderUtilss.mc.getRenderViewEntity().posZ);
        if (RenderUtilss.camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtilss.mc.getRenderManager().viewerPosX, bb.minY + RenderUtilss.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtilss.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtilss.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtilss.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtilss.mc.getRenderManager().viewerPosZ))) {
            GlStateManager.pushMatrix();
            GlStateManager.enableBlend();
            GlStateManager.disableDepth();
            GlStateManager.tryBlendFuncSeparate(770, 771, 0, 1);
    ...
    public static void drawBox(final BlockPos pos, final Color color, final double height, final boolean gradient, final boolean invert, final int alpha) {
        ...
        final AxisAlignedBB bb = new AxisAlignedBB(pos.getX() - RenderUtilss.mc.getRenderManager().viewerPosX, pos.getY() - RenderUtilss.mc.getRenderManager().viewerPosY, pos.getZ() - RenderUtilss.mc.getRenderManager().viewerPosZ, pos.getX() + 1 - RenderUtilss.mc.getRenderManager().viewerPosX, pos.getY() + 1 - RenderUtilss.mc.getRenderManager().viewerPosY + height, pos.getZ() + 1 - RenderUtilss.mc.getRenderManager().viewerPosZ);
        RenderUtilss.camera.setPosition(Objects.requireNonNull(RenderUtilss.mc.getRenderViewEntity()).posX, RenderUtilss.mc.getRenderViewEntity().posY, RenderUtilss.mc.getRenderViewEntity().posZ);
        if (RenderUtilss.camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtilss.mc.getRenderManager().viewerPosX, bb.minY + RenderUtilss.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtilss.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtilss.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtilss.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtilss.mc.getRenderManager().viewerPosZ))) {
            GlStateManager.pushMatrix();
            GlStateManager.enableBlend();
    ...
    public static void drawBlockOutline(final BlockPos pos, final Color color, final float linewidth, final boolean air) {
        final IBlockState iblockstate = RenderUtilss.mc.world.getBlockState(pos);
        if ((air || iblockstate.getMaterial() != Material.AIR) && RenderUtilss.mc.world.getWorldBorder().contains(pos)) {
            final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtilss.mc.player, RenderUtilss.mc.getRenderPartialTicks());
            drawBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtilss.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), color, linewidth);
        }
    }
    ...
    public static void drawBlockOutline(final BlockPos pos, final Color color, final float linewidth, final boolean air, final double height, final boolean gradient, final boolean invert, final int alpha) {
        ...
        final IBlockState iblockstate = RenderUtilss.mc.world.getBlockState(pos);
        if ((air || iblockstate.getMaterial() != Material.AIR) && RenderUtilss.mc.world.getWorldBorder().contains(pos)) {
            final AxisAlignedBB blockAxis = new AxisAlignedBB(pos.getX() - RenderUtilss.mc.getRenderManager().viewerPosX, pos.getY() - RenderUtilss.mc.getRenderManager().viewerPosY, pos.getZ() - RenderUtilss.mc.getRenderManager().viewerPosZ, pos.getX() + 1 - RenderUtilss.mc.getRenderManager().viewerPosX, pos.getY() + 1 - RenderUtilss.mc.getRenderManager().viewerPosY + height, pos.getZ() + 1 - RenderUtilss.mc.getRenderManager().viewerPosZ);
    ...
    public static void drawBoxESP(final BlockPos pos, final Color color, final float lineWidth, final boolean outline, final boolean box, final int boxAlpha) {
        ...
        if (RenderUtilss.camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtilss.mc.getRenderManager().viewerPosX, bb.minY + RenderUtilss.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtilss.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtilss.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtilss.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtilss.mc.getRenderManager().viewerPosZ))) {
            ...
            GL11.glHint(3154, 4354);
            GL11.glLineWidth(lineWidth);
            final double dist = RenderUtilss.mc.player.getDistance((double)(pos.getX() + 0.5f), (double)(pos.getY() + 0.5f), (double)(pos.getZ() + 0.5f)) * 0.75;
            if (box) {
    ...
    public static void drawOutlinedBlockESP(final BlockPos pos, final Color color, final float linewidth) {
        final IBlockState iblockstate = RenderUtilss.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtilss.mc.player, RenderUtilss.mc.getRenderPartialTicks());
        drawBoundingBox(iblockstate.getSelectedBoundingBox((World)RenderUtilss.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), linewidth, ColorUtil.toRGBA(color));
    }

    public static void blockEsp(final BlockPos blockPos, final Color c, final double length, final double length2) {
        final double x = blockPos.getX() - RenderUtilss.mc.renderManager.renderPosX;
        final double y = blockPos.getY() - RenderUtilss.mc.renderManager.renderPosY;
        final double z = blockPos.getZ() - RenderUtilss.mc.renderManager.renderPosZ;
        GL11.glPushMatrix();
    ...
    public static void glrendermethod() {
        ...
        GL11.glEnable(2884);
        GL11.glDisable(2929);
        final double viewerPosX = RenderUtilss.mc.getRenderManager().viewerPosX;
        final double viewerPosY = RenderUtilss.mc.getRenderManager().viewerPosY;
        final double viewerPosZ = RenderUtilss.mc.getRenderManager().viewerPosZ;
        GL11.glPushMatrix();
    ...
    public static AxisAlignedBB getBoundingBox(final BlockPos blockPos) {
        return RenderUtilss.mc.world.getBlockState(blockPos).getBoundingBox((IBlockAccess)RenderUtilss.mc.world, blockPos).offset(blockPos);
    }
    ...
    public static void glBillboard(final float x, final float y, final float z) {
        ...
        GlStateManager.translate(x - RenderUtilss.mc.getRenderManager().renderPosX, y - RenderUtilss.mc.getRenderManager().renderPosY, z - RenderUtilss.mc.getRenderManager().renderPosZ);
        GlStateManager.glNormal3f(0.0f, 1.0f, 0.0f);
        GlStateManager.rotate(-RenderUtilss.mc.player.rotationYaw, 0.0f, 1.0f, 0.0f);
        GlStateManager.rotate(RenderUtilss.mc.player.rotationPitch, (RenderUtilss.mc.gameSettings.thirdPersonView == 2) ? -1.0f : 1.0f, 0.0f, 0.0f);
    ...
    public static void drawSphere(final double x, final double y, final double z, final float size, final int slices, final int stacks) {
        ...
        GL11.glTranslated(x - RenderUtilss.mc.renderManager.renderPosX, y - RenderUtilss.mc.renderManager.renderPosY, z - RenderUtilss.mc.renderManager.renderPosZ);
    ...
    public static void GLPre(final float lineWidth) {
        RenderUtilss.depth = GL11.glIsEnabled(2896);
        RenderUtilss.texture = GL11.glIsEnabled(3042);
        RenderUtilss.clean = GL11.glIsEnabled(3553);
        RenderUtilss.bind = GL11.glIsEnabled(2929);
        RenderUtilss.override = GL11.glIsEnabled(2848);
        GLPre(RenderUtilss.depth, RenderUtilss.texture, RenderUtilss.clean, RenderUtilss.bind, RenderUtilss.override, lineWidth);
    }

    public static void GlPost() {
        GLPost(RenderUtilss.depth, RenderUtilss.texture, RenderUtilss.clean, RenderUtilss.bind, RenderUtilss.override);
    }
    ...
    public static Vec3d to2D(final double x, final double y, final double z) {
        ...
        GL11.glGetFloat(2983, RenderUtilss.projection);
        GL11.glGetInteger(2978, RenderUtilss.viewport);
        final boolean result = GLU.gluProject((float)x, (float)y, (float)z, RenderUtilss.modelView, RenderUtilss.projection, RenderUtilss.viewport, RenderUtilss.screenCoords);
        if (result) {
            return new Vec3d((double)RenderUtilss.screenCoords.get(0), (double)(Display.getHeight() - RenderUtilss.screenCoords.get(1)), (double)RenderUtilss.screenCoords.get(2));
        }
        return null;
    }
    ...
    public static boolean isInViewFrustrum(final AxisAlignedBB bb) {
        ...
        RenderUtilss.frustrum.setPosition(current.posX, current.posY, current.posZ);
        return RenderUtilss.frustrum.isBoundingBoxInFrustum(bb);
    }
    ...
    public static void checkSetupFBO() {
        final Framebuffer fbo = RenderUtilss.mc.framebuffer;
    ...
    private static void setupFBO(final Framebuffer fbo) {
        ...
        EXTFramebufferObject.glRenderbufferStorageEXT(36161, 34041, RenderUtilss.mc.displayWidth, RenderUtilss.mc.displayHeight);
        EXTFramebufferObject.glFramebufferRenderbufferEXT(36160, 36128, 36161, stencilDepthBufferID);
        EXTFramebufferObject.glFramebufferRenderbufferEXT(36160, 36096, 36161, stencilDepthBufferID);
    }

    static {
        RenderUtilss.itemRender = RenderUtilss.mc.getRenderItem();
        RenderUtilss.camera = (ICamera)new Frustum();
