...
public class StayTessellator extends Tessellator {
    public static Minecraft mc = Minecraft.getMinecraft();
    public static StayTessellator INSTANCE = new StayTessellator();
    ...
    public static void drawBoundingBox(AxisAlignedBB bb, float width, int argb) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        StayTessellator.drawBoundingBox(bb, width, r, g, b, a);
    }
    ...
    public static void glBillboard(float x, float y, float z) {
        ...
        GlStateManager.translate((double) x -  ((AccessorRenderManager) Minecraft.getMinecraft().getRenderManager()).getRenderPosX(), (double) y -  ((AccessorRenderManager) Minecraft.getMinecraft().getRenderManager()).getRenderPosY(), (double) z -  ((AccessorRenderManager) Minecraft.getMinecraft().getRenderManager()).getRenderPosZ());
    ...
    public static Vec3d interpolateEntityClose(Entity entity, float renderPartialTicks) {
        return new Vec3d(calculateDistanceWithPartialTicks(entity.posX, entity.lastTickPosX, renderPartialTicks) -  ((AccessorRenderManager) Minecraft.getMinecraft().getRenderManager()).getRenderPosX(), calculateDistanceWithPartialTicks(entity.posY, entity.lastTickPosY, renderPartialTicks) -  ((AccessorRenderManager) Minecraft.getMinecraft().getRenderManager()).getRenderPosY(), calculateDistanceWithPartialTicks(entity.posZ, entity.lastTickPosZ, renderPartialTicks) -  ((AccessorRenderManager) Minecraft.getMinecraft().getRenderManager()).getRenderPosZ());
    }

    public static double calculateDistanceWithPartialTicks(double n, double n2, float renderPartialTicks) {
        return n2 + (n - n2) * (double) Wrapper.mc.getRenderPartialTicks();
    }
