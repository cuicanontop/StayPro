...
import dev.cuican.staypro.utils.NordTessellator;
import dev.cuican.staypro.utils.TotemPopCham;
...
@ModuleInfo(name = "PopChams",description = "Renders when some1 pops", category = Category.RENDER)
public class PopChams extends Module {
    public  final Setting<Boolean> self =   setting("Self", false);
    public  final Setting<Integer> rL = setting("RedLine", 255, 0, 255);
    public  final Setting<Integer> gL = setting("GreenLine", 26, 0, 255);
    public  final Setting<Integer> bL =  setting("BlueLine", 42, 0, 255);
    public  final Setting<Integer> aL =  setting("AlphaLine", 42, 0, 255);

    public  final Setting<Integer> rF =setting("RedFill", 255, 0, 255);
    public  final Setting<Integer> gF = setting("GreenFill", 26, 0, 255);
    public  final Setting<Integer> bF =setting("BlueFill", 42, 0, 255);
    public  final Setting<Integer> aF =setting("AlphaFill", 42, 0, 255);

    public  final Setting<Integer> fadestart =setting("FadeStart", 200, 0, 3000);
    public  final Setting<Double> fadetime = setting("FadeStart", .5, .0,2d);
    public  final Setting<Boolean> onlyOneEsp =setting("OnlyOneEsp", true);
    public  final Setting<Boolean> rainbow = setting("Rainbow", false);
