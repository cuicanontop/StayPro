...
public class OffHandCrystal extends Module {
    ...
    Setting<String> mode = setting("Item", "Crystal", listOf("Gap", "Crystal","POP","CUICAN"));
    ...
    Setting<String> switchMode = setting("GapWhen", "Sword", listOf("Sword", "RClick")).whenTrue(autoSwitch);
    ...
    public void onRenderTick() {
        ...
        if (mode.getValue().equals("CUICAN")){
            offhandItem =  Items.TOTEM_OF_UNDYING;
            sOffhandItem = Items.GOLDEN_APPLE;
        }else {
            offhandItem = mode.getValue().equals("Crystal") ? Items.END_CRYSTAL : Items.GOLDEN_APPLE;
            sOffhandItem = mode.getValue().equals("Crystal") ? Items.GOLDEN_APPLE : Items.END_CRYSTAL;
        }


        boolean shouldSwitch;

        if (switchMode.getValue().equals("Sword")) {
