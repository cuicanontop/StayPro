...
@ModuleInfo(name = "Aimbot", category = Category.HIDDEN, visible = false)
...
//    }
    ...
    @Listener
    public void Post(UpdateWalkingPlayerEvent event) {
        if (event.getStage() == 1) {
            if (shouldReset) {
