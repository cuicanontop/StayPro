 ...
 */
@ModuleInfo(name = "EntitySpeed", category = Category.MOVEMENT, description = "Abuse client-sided movement to shape sound barrier breaking rideables")
public class EntitySpeed extends Module {

    private Setting<Float> speed = setting("Speed",1f,0,100);
    private Setting<Boolean> antiStuck = setting("AntiStuck",true);
    private Setting<Boolean> flight = setting("Flight",false);
    private Setting<Boolean> wobble = setting("Wobble",false);

    private static EntitySpeed INSTANCE;
    public EntitySpeed() {
        this.setInstance();
    }
