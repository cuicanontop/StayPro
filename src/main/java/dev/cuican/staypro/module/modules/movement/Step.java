...
@ModuleInfo(name = "Step", category = Category.MOVEMENT,description = "Like a spiderman")
public class Step extends Module {
    private final Setting<String> mode = setting("Mode", "NCP",listOf( "VANILLA", "NCP"));
    private final Setting<Boolean> reverse = setting("ReverseStep", true);
    private final Setting<Double> height = setting("Height", 2.0, 0.0, 5.0);
