package dev.cuican.staypro.module.pingbypass.guis;


import dev.cuican.staypro.client.ModuleManager;
import dev.cuican.staypro.module.pingbypass.PingBypass;
import dev.cuican.staypro.module.pingbypass.util.IdleUtil;
import dev.cuican.staypro.module.pingbypass.util.ThreadUtil;
...
public class GuiConnectingPingBypass extends GuiScreen
{
    ...
    public GuiConnectingPingBypass(GuiScreen parent, Minecraft mcIn, ServerData serverDataIn)
    {
        ...
        PingBypass module = (PingBypass) ModuleManager.getModule(PingBypass.class);
